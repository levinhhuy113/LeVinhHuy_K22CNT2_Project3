...
<%@ page import="dao.NhaCungCapDAO, model.NhaCungCap" %>
<%
    ...
    <div class="form-container">
        ...
        <form action="NhaCungCapServlet" method="post">
            ...
            <fieldset>
                ...
                <input type="text" id="tenNCC" name="tenNCC" value="<%= ncc.getTenNCC() %>" required>
                <label for="diaChi">Địa Chỉ:</label>
                <input type="text" id="diaChi" name="diaChi" value="<%= ncc.getDiaChi() %>" required>
                <label for="soDienThoai">Số Điện Thoại:</label>
                <input type="text" id="soDienThoai" name="soDienThoai" value="<%= ncc.getSoDienThoai() %>" required>
