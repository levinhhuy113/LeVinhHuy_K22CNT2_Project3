...
i.fa-solid.fa-cloud-arrow-down {
  ...
  <body>
    ...
    <%
        List<NhaCungCap> danhSachNhaCungCap = (List<NhaCungCap>) request.getAttribute("danhSachNhaCungCap");

        if (danhSachNhaCungCap == null || danhSachNhaCungCap.isEmpty()) {
    %>
        <p style="color: red; text-align: center;">Không có nhà cung cấp nào!</p>
    <%
        } else {
    %>
        <table>
